...
import { getLengthOfStay } from '../BookingPage/stayLength'
...
function BookingConfirmation() {
    ...
    if(booking && booking.id) {
        convertedDateRange = convertDates(booking?.startDate, booking?.endDate)
    } else {
        convertedDateRange = ''
    }

    const numNights = getStayLength(booking.startDate, booking.endDate)
    // console.log(numNights)

    const [lengthOfStay, setLengthOfStay] = useState(numNights)
    const [dateRange, setDateRange] = useState(convertedDateRange)
            ...
            <div id='booking-details-wrapper'>
                <div id='booking-confirmation-details-top-half'>
                    ...
                    <div id='bc-los-container'>
                        ...
                        <div>
                            <p className='bc-p'>{lengthOfStay} nights</p>
                        </div>
                    </div>
                </div>
